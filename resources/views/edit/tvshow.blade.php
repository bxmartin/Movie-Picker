<x-app-layout>
    ...
    <section>
        <div
            ...
            <form method="POST" action="/tvshow/{{ $tvshow->id }}/update" class="w-full px-8 pb-6 md:w-1/2"
                ...
                <div class="mb-4">
                    ...
                    <x-input-error :messages="$errors->get('name', $tvshow->name)" class="mt-2" />
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <select id="effort"
                        class="block w-full mt-1 border-gray-300 rounded-md shadow-sm dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600"
                        type="text" name="effort" :value="old('effort', $tvshow->effort)" required>
