<x-layout>
    <div class="flex justify-center my-8">
        <div class="flex basis-1/2">
            <div class="basis-2/5 bg-gray-100 rounded-3xl py-5 px-8 text-center">
                <img src="https://m.media-amazon.com/images/M/MV5BOTA5NjhiOTAtZWM0ZC00MWNhLThiMzEtZDFkOTk2OTU1ZDJkXkEyXkFqcGdeQXVyMTA4NDI1NTQx._V1_FMjpg_UX1000_.jpg">
                <h1 class="text-2xl font-semibold my-2">Star Wars</h1>
    ...
    <table class="leading-normal w-full">
        <thead class="table-header-group">
            <tr>
                ...
                <th class="px-5 py-3 border-b-2 border-gray-200 bg-indigo-600 text-left font-semibold text-slate-50 uppercase tracking-wider">Genre</th>
                ...
                <th class="px-5 py-3 border-b-2 border-gray-200 bg-indigo-600 text-left font-semibold text-slate-50 uppercase tracking-wider">Watched</th>
                <th class="px-5 py-3 border-b-2 border-gray-200 bg-indigo-600 text-left font-semibold text-slate-50 uppercase tracking-wider rounded-tr-2xl">Actions</th>
            </tr>
        </thead>
        <tbody>
            <tr class="odd:bg-white even:bg-slate-50">
                <td class="px-5 py-3 border-b border-gray-200 font-bold">Star Wars</td>
                <td class="px-5 py-3 border-b border-gray-200">Sci-Fi</td>
    ...
    <table class="leading-normal w-full">
        ...
        <tbody>
            <tr class="odd:bg-white even:bg-slate-50">
                ...
                <td class="px-5 py-3 border-b border-gray-200">Drama</td>
